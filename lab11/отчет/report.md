...
Кулябов Д. С. и др.Операционные системы65
...
число аргументов командной строки, в том числе превышающее десять. Например, скрипт может вывести число ввёденое пользователем.
